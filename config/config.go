...
import (
	...
	"github.com/remixd-media/prebid-server/macros"
...
func SetupViper(v *viper.Viper, filename string) {
	...
	// If you're using one of these, make sure you check out the documentation (https://github.com/remixd-media/prebid-server/tree/master/docs/bidders)
