...
[![Go Report Card](https://goreportcard.com/badge/github.com/remixd-media/prebid-server?style=flat-square)](https://goreportcard.com/report/github.com/remixd-media/prebid-server)
...
```bash
cd $GOPATH
git clone https://github.com/remixd-media/prebid-server src/github.com/remixd-media/prebid-server
cd src/github.com/remixd-media/prebid-server
dep ensure
```
...
Report bugs, request features, and suggest improvements [on Github](https://github.com/remixd-media/prebid-server/issues).

Or better yet, [open a pull request](https://github.com/remixd-media/prebid-server/compare) with the changes you'd like to see.
