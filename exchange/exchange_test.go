...
// 	   as specified in https://github.com/remixd-media/prebid-server/issues/465
...
// 	   sample request as specified in https://github.com/remixd-media/prebid-server/issues/465
...
func TestCharacterEscape(t *testing.T) {
	...
	/*    https://github.com/remixd-media/prebid-server/issues/465	*/
	cfg := &config.Configuration{
	...
	//An openrtb.BidRequest struct as specified in https://github.com/remixd-media/prebid-server/issues/465
